...
public class Grid_Float {

    public float HEAT_MAP_MAX_VALUE = 100;
    public float HEAT_MAP_MIN_VALUE = 0;
    ...
    public Grid_Float(int width, int height, float cellSize, Vector3 originPosition) {
        this.width = width;
        this.height = height;
